...
Sub import(ByVal folder_path, ByVal columnsletters_, ByVal import_file_pattern, ByVal sep, ByVal sheet_name, ByVal nb_lines_to_skip, ByVal writeNameOfFile)
    ' Deal with arguments
    If folder_path = "" Then
        folder_path = "C:\myfolder1\myfolder2"
    End If
    ...
    If writeNameOfFile = "" Then
        writeNameOfFile = True
    End If
